        ...
        <div className="grid grid-cols-[repeat(auto-fit,minmax(200px,1fr))] gap-[clamp(2rem,4vw,3rem)]">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm font-medium mt-4 pt-4 border-t border-white/10">
              <li>
                <a href="mailto:khelclan@gmail.com" className="text-emerald-100 hover:text-white transition-colors flex items-center gap-2 font-bold">
                  <Mail className="w-4 h-4 text-emerald-300" /> khelclan@gmail.com
                </a>
              </li>
              <li>
