...
export default function InteractiveFeaturesSection() {
  ...
  return (
    <section ref={sectionRef} className="relative w-full z-20 mb-32">
      {/* Scroll Trigger Area (400vh to give enough scroll distance) */}
      <div ref={triggerRef} className="relative min-h-[400vh]">
        
        {/* Sticky Viewport */}
        <div className="sticky top-0 h-screen flex flex-col justify-center max-w-[1400px] mx-auto px-4 md:px-8 overflow-hidden">
                ...
                <SmartboardFrame>
                  <div className="w-full h-full bg-[#F3F4F6] p-1.5 flex gap-1.5 relative overflow-hidden">
                    ...
                    <div className="flex-1 bg-white rounded-2xl sm:rounded-r-2xl border border-slate-200 overflow-hidden relative flex z-10">
                      ...
                      <div className={`absolute inset-0 flex transition-opacity duration-500 bg-white ${activeStep === 1 ? 'opacity-100 z-10' : 'opacity-0 z-0'}`}>
                      ...
                      {/* State 2: Video */}
                      <div className={`absolute inset-0 flex flex-col transition-opacity duration-500 bg-black ${activeStep === 2 ? 'opacity-100 z-10' : 'opacity-0 z-0'}`}>
                      ...
                      {/* State 3: Mind Map */}
                      <div className={`absolute inset-0 flex items-center justify-center transition-opacity duration-500 bg-[#F4F6F2] ${activeStep === 3 ? 'opacity-100 z-10' : 'opacity-0 z-0'}`}>
                      ...
                      {/* State 4: Quiz */}
                      <div className={`absolute inset-0 flex flex-col justify-center transition-opacity duration-500 bg-slate-50 p-8 sm:p-12 ${activeStep === 4 ? 'opacity-100 z-10' : 'opacity-0 z-0'}`}>
                      ...
                      <div className={`absolute inset-0 flex flex-col transition-opacity duration-500 bg-slate-100 p-8 ${activeStep === 5 ? 'opacity-100 z-10' : 'opacity-0 z-0'}`}>
                      ...
                      {/* State 6: Worksheet */}
                      <div className={`absolute inset-0 flex items-center justify-center transition-opacity duration-500 bg-slate-200 p-6 ${activeStep === 6 ? 'opacity-100 z-10' : 'opacity-0 z-0'}`}>
