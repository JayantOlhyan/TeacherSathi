...
export const NCERT_SYLLABUS: ClassSyllabus = {
  ...
  "Class 7": {
    ...
    "English": [
      ...
      {"id": 10, "en": "Courage", "hi": "साहस", "descEn": "Unit 3: Dreams and Discoveries - A lesson on facing fears with inner strength.", "descHi": "इकाई 3: डर का सामना करने का एक पाठ।"},
      {"id": 11, "en": "The Tunnel", "hi": "सुरंग", "descEn": "Unit 4: Travel and Adventure - An adventurous journey through a mysterious tunnel.", "descHi": "इकाई 4: एक साहसिक यात्रा की कहानी।"},
      {"id": 12, "en": "Travel", "hi": "यात्रा", "descEn": "Unit 4: Travel and Adventure - A poem celebrating the joys and wonder of travelling.", "descHi": "इकाई 4: यात्रा की खुशियों के बारे में एक कविता।"},
      {"id": 13, "en": "Conquering the Summit", "hi": "शिखर पर विजय", "descEn": "Unit 4: Travel and Adventure - A true story of mountaineering achievement.", "descHi": "इकाई 4: पर्वतारोहण उपलब्धि की सच्ची कहानी।"},
      {"id": 14, "en": "A Homage to Our Brave Soldiers", "hi": "हमारे वीर सैनिकों को श्रद्धांजलि", "descEn": "Unit 5: Bravehearts - Honoring the sacrifices and valor of our armed forces.", "descHi": "इकाई 5: सशस्त्र बलों के बलिदान का सम्मान।"},
      {"id": 15, "en": "The Kargil Girl", "hi": "कारगिल गर्ल", "descEn": "Unit 5: Bravehearts - The inspiring story of IAF pilot Gunjan Saxena.", "descHi": "इकाई 5: गुंजन सक्सेना की प्रेरक कहानी।"},
      {"id": 16, "en": "The Mirror", "hi": "दर्पण", "descEn": "Unit 5: Bravehearts - A reflective piece on self-discovery and courage.", "descHi": "इकाई 5: आत्म-खोज पर एक चिंतनशील लेख।"},
      {"id": 17, "en": "The Day We Saved the Forest", "hi": "जिस दिन हमने जंगल को बचाया", "descEn": "Unit 5: Bravehearts - An inspiring narrative about environmental conservation.", "descHi": "इकाई 5: पर्यावरण संरक्षण के बारे में एक कहानी।"}
    ],
    "Social Science": [
