        ...
        <div className="w-full max-w-[420px] space-y-6">
          <div className="text-center space-y-2">
            ...
            <p className="text-xs text-ink-3 mt-1 leading-relaxed">
              Log in to access saved AI lesson plans, NCERT mind maps, classroom quizzes, and reports tailored for Indian government schools.
            </p>
          </div>
          ...
          {authMethod === "email" && (
            <form className="space-y-4">
              ...
              <div className="flex justify-end">
                <Link href="/forgot-password" className="text-sm text-brand hover:underline font-semibold">
                  {t('forgot_password')}
                </Link>
              </div>
